...
parser.add_argument('--pretrained', default='./model/SOTA/ijba_res18_naive.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
...
#                                weight_decay=args.weight_decay)
   # optionally resume from a checkpoint
    ...
    if args.pretrained:
        ...
        checkpoint = torch.load('./model/SOTA/ijba_res18_naive.pth.tar')
